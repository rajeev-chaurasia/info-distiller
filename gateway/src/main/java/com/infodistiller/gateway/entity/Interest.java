...
public class Interest {
    ...
    @Column(name = "updated_at", nullable = false, updatable = false, insertable = false, columnDefinition = "TIMESTAMPTZ DEFAULT NOW()")
    ...
    public String getAllowlistJson() { return allowlistJson; }
    public void setAllowlistJson(String allowlistJson) { this.allowlistJson = allowlistJson; }
    public String getDenylistJson() { return denylistJson; }
    public void setDenylistJson(String denylistJson) { this.denylistJson = denylistJson; }
